...
public class Film {
	...
	public String toString() {
		return "Film [_Id=" + _Id + ", title=" + title + ", description=" + description + ", releaseYear="
	...
	public Film(ObjectId _Id, String title, String description, Integer releaseYear, Language language,
